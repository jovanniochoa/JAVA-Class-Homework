//this class is supposed to add to the binary tree and get the characters from it
// and be able to delete words if may be to the list given the specific word.
class bst{
    ...
    //insets the numbers in the tree
    ...
    //checks if the boolean containing the word
    ...
    //returns the record of the word
    ...
    //gets the record of the current word
